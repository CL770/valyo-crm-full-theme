...
new CustomEChart({
    ...
    options: () => ({
        tooltip: {
            ...
            axisLine: {
                lineStyle: {
                    color: ins("tertiary-bg"), type: "solid"
                }
            },
            axisTick: {show: false},
            axisLabel: {
            ...
            scale: true, axisPointer: {show: false}, splitLine: {
                lineStyle: {
                    color: ins("border-color"), type: "dashed"
                }
            }, boundaryGap: false, axisLabel: {
                show: true, color: ins("body-color"), margin: 15, fontWeight: 500
            }, axisTick: {show: false}, axisLine: {show: false}
        }, textStyle: {
            fontFamily: getComputedStyle(document.body).fontFamily
        }, series: [{
            type: "candlestick", name: "Volume", data: data.map(d => d.slice(1)), itemStyle: {
                color: ins("warning"), color0: ins("primary"), borderColor: ins("warning"), borderColor0: ins("primary")
            }
        }], grid: {
...
new CustomEChart({
    ...
    options: () => ({
        backgroundColor: 'transparent', tooltip: {
            ...
            data: ['INS', 'MA5', 'MA10', 'MA20', 'MA30'], textStyle: {color: ins("body-color")}
        }, grid: {
            ...
            borderColor: ins("border-color"),
            fillerColor: ins('primary-rgb', 0.25),
            dataBackground: {
                lineStyle: {
                    color: ins("primary")
                }, areaStyle: {
            ...
            handleSize: '100%',
            handleStyle: {
                color: ins("primary"), borderColor: ins("border-color")
            },
            textStyle: {
                color: ins("body-color")
            },
            ...
            name: 'INS', type: 'candlestick', data: mixedData.values, itemStyle: {
                color: ins("primary"),
                color0: ins("danger"),
                borderColor: ins("primary"),
                borderColor0: ins("danger")
            }, markPoint: {
                label: {
