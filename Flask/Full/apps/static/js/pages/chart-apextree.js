...
const data1 = {
    ...
    data: {
        name: 'Lucas Alex',
        imageURL: '/static/images/users/user-1.jpg',
    },
    options: {
    ...
    children: [
        {
            ...
            data: {
                name: 'Alex Lee',
                imageURL: '/static/images/users/user-3.jpg',
            },
            options: {
            ...
            children: [
                {
                    ...
                    data: {
                        name: 'Mia Patel',
                        imageURL: '/static/images/users/user-9.jpg',
                    },
                    options: {
                ...
                },
                {
                    ...
                    data: {
                        name: 'Ryan Clark',
                        imageURL: '/static/images/users/user-10.jpg',
                    },
                    options: {
                        nodeBGColor: ins('info-rgb', 0.5),
                    },
                },
                {
                    ...
                    data: {
                        name: 'Zoe Wang',
                        imageURL: '/static/images/users/user-2.jpg',
                    },
                    options: {
                        nodeBGColor: ins('info-rgb', 0.5),
                    },
        ...
        },
        {
            ...
            data: {
                name: 'Leo Kim',
                imageURL: '/static/images/users/user-6.jpg',
            },
            options: {
                nodeBGColor: ins('danger-rgb', 0.5),
            },
            children: [
                ...
                },
                {
                    ...
                    data: {
                        name: 'Maya Gupta',
                        imageURL: '/static/images/users/user-7.jpg',
                    },
                    options: {
                        nodeBGColor: ins('purple-rgb', 0.5),
                    },
...

        {
            ...
            data: {
                name: 'Lily Chen',
                imageURL: '/static/images/users/user-4.jpg',
            },
            options: {
                nodeBGColor: ins('danger-rgb', 0.5),
            },
        ...
        },
        {
            ...
            data: {
                name: 'Max Ruiz',
                imageURL: '/static/images/users/user-8.jpg',
            },
            options: {
                nodeBGColor: ins('danger-rgb', 0.5),
            },
